...
namespace OOP_Laba_9
{
    ...
    public partial class App : Application
    {
        ...
        {
            Language = OOP_Laba_9.Properties.Settings.Default.DefaultLanguage;
        }

        private void App_LanguageChanged(Object sender, EventArgs e)
        {
            OOP_Laba_9.Properties.Settings.Default.DefaultLanguage = Language;
            OOP_Laba_9.Properties.Settings.Default.Save();
        }
    }
